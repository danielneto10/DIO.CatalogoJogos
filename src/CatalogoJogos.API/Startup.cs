...
using CatalogoJogos.Application.Services;
using CatalogoJogos.Infrastructure.Context;
using CatalogoJogos.Infrastructure.Interfaces;
using CatalogoJogos.Infrastructure.Repositories;
...
namespace CatalogoJogos.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CatalogoJogosContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Default")));
